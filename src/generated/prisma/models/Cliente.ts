...
export type ClienteWhereInput = {
  ...
  clerkId?: Prisma.StringFilter<"Cliente"> | string
...
export type ClienteScalarWhereWithAggregatesInput = {
  ...
  clerkId?: Prisma.StringWithAggregatesFilter<"Cliente"> | string
}
...
export type ClienteUpdateInput = {
  user?: Prisma.UserUpdateOneRequiredWithoutClienteNestedInput
}
...
export type ClienteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"clerkId", ExtArgs["result"]["cliente"]>
...
export interface ClienteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const clienteWithClerkIdOnly = await prisma.cliente.findMany({ select: { clerkId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Clientes and only return the `clerkId`
   * const clienteWithClerkIdOnly = await prisma.cliente.createManyAndReturn({
   *   select: { clerkId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Clientes and only return the `clerkId`
   * const clienteWithClerkIdOnly = await prisma.cliente.updateManyAndReturn({
   *   select: { clerkId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ClienteFieldRefs {
  readonly clerkId: Prisma.FieldRef<"Cliente", 'String'>
}
